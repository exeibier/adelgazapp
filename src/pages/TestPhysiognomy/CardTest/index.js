...
export default class CardTest extends Component {
  ...
  render() {
    ...
    return (
      <form
        className="border p-3 rounded test-form"
        onSubmit={this.handleFormSubmit}
      >
        <ol>
          <li className="data-form">¿Qué edad tienes?</li>
          <div className="form-group">
            <input
              className=" form-control info-test "
              placeholder="Edad"
              type={"text"}
              value={age}
          ...
          <li className="data-form">¿Eres hombre mujer?</li>
          ...
          <li className="data-form">¿Cuál es el diametro de tu muñeca?</li>
          <div className="form-group">
            <input
              className=" form-control info-test "
              placeholder="cm"
          ...
          <li className="data-form">¿Cual es tu altura?</li>
          <div className="form-group">
            <input
              className=" form-control info-test"
              placeholder="cm"
          ...
          <li className="data-form">¿Cuánto pesas hoy?</li>
          <div className="form-group">
            <input
              className=" form-control info-test"
              placeholder="Kg"
          ...
          <li className="data-form">¿Cuál es tu nivel de actividad física?</li>
          <div className="d-flex justify-content-between form-group">
            <select
              class="form-control"
              name={"exercise"}
          ...
          <li className="data-form">¿Cuál es tu objetivo?</li>
        ...
        <button className="btn-send my-3 btn-block" type="submit">
          ENVIAR
        </button>
      </form>
    );
