        ...
        <div className="container test-wrapper ">
          <div className="row">
            <div className="col-12">
              <h1 className="text-center welcome my-3 mt-5 mb-5"> ¡BIENVENIDO!</h1>
            </div>
          </div>
          <div className="row">
            <div className="col-12 col-md-6">
              <div className="wrapper-image w-100  border rounded-lg d-none d-md-block">
                <h2>TIPS</h2>
                <p>
                  º Incorporar a diario alimentos de todos los grupos y realizar
                  al menos 30 minutos de actividad física
                </p>
                <p>Tomar a diario 8 vasos de agua</p>
                <p>
                ...
                <p>
                  ºAl consumir carnes quitarle la grasa visible, aumentar el
